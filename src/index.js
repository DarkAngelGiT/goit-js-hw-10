...
// Додаємо подію на input
refs.searchInput.addEventListener('input', debounce(onSearch, DEBOUNCE_DELAY));

// Ф-ція отримання тексту введеного користувачем в input
...
// Ф-ція створення розмітки для  2-10 країн
...
// Ф-ція що рендерить розмітку в залежності від к-ті країн
